...
export default function Hero() {
  ...
  return (
    <section id="home" className="bg-gradient-to-r from-forest to-eco text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Smart Waste Management</h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
            Find disposal facilities, learn sustainable practices, and contribute to a cleaner campus environment
          </p>
